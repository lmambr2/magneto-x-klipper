# magneto-x-klipper (Kalico track)

**Kalico + Magneto X** extras for the Peopoly Magneto X (MagXY + Lancer).

| Branch | Base | Role |
|--------|------|------|
| [`magneto-x`](https://github.com/lmambr2/magneto-x-klipper/tree/magneto-x) | Klipper3d | **Default** — recommended first |
| **`magneto-x-kalico`** (this branch) | [Kalico](https://github.com/KalicoCrew/kalico) | Optional A/B track |

- Project umbrella: [lmambr2/magneto-x](https://github.com/lmambr2/magneto-x)
- Track comparison / switch guide: [docs/TRACKS.md](docs/TRACKS.md)
- Magneto notes: [docs/Magneto_X.md](docs/Magneto_X.md)
- Upstream sync (Kalico): [docs/UPSTREAM_SYNC.md](docs/UPSTREAM_SYNC.md)
- Guard: `python3 scripts/magneto_guard.py`
- **Do not open PRs against Klipper3d or KalicoCrew for Magneto patches.**

Not affiliated with Peopoly or KalicoCrew.
